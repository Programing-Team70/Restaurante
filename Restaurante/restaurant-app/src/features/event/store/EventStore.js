    ...
    try {
      ...
      set({
        error:
          ...
          "Error al obtener los eventos globales de Heaven Flavor.",
        loading: false,
      });
    }
  },
  ...
  getEventsByRestaurant: async (restaurantId) => {
    try {
      ...
      set({
        error:
          error.response?.data?.message ||
          "Error al filtrar los eventos por sucursal.",
        loading: false,
      });
    }
  },
  ...
  createEvent: async (eventData) => {
    try {
      ...
      set({
        error:
          error.response?.data?.message ||
          "Error al registrar el nuevo evento.",
        loading: false,
      });
      throw error;
    }
  ...
  cancelEvent: async (id) => {
    try {
      ...
      set({
        error:
          error.response?.data?.message ||
          "Error al intentar cancelar el evento.",
        loading: false,
      });
    }
  },
  ...
  deleteEvent: async (id) => {
    try {
      ...
      set({
        error:
          error.response?.data?.message ||
          "Error al desactivar el evento de la plataforma.",
        loading: false,
      });
    }
  },
