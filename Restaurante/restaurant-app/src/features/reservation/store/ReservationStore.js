...
} from "../../../shared/api/Reservation.js";
...
export const useReservationStore = create((set, get) => ({
  ...
  getReservationsByRestaurant: async (restaurantId) => {
    try {
      ...
      set({
        reservations: response.data?.reservations || response.data?.data || [],
        loading: false,
      });
    } catch (error) {
      set({
        error:
          error.response?.data?.message ||
          "Error al obtener las reservaciones del restaurante.",
        loading: false,
      });
    }
  },
  ...
  cancelReservation: async (id) => {
    try {
      ...
      set({
        error:
          error.response?.data?.message || "Error al cancelar la reservación.",
        loading: false,
      });
    }
  },
  ...
  deleteReservation: async (id) => {
    try {
      ...
      set({
        error:
          error.response?.data?.message ||
          "Error al desactivar la reservación.",
        loading: false,
      });
    }
  },
