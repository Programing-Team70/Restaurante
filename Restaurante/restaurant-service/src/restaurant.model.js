...
const restaurantSchema = new Schema(
  {
    restaurantName: {
      ...
      maxLength: [
        200,
        "El nombre del restaurante no puede exceder 200 caracteres.",
      ],
    },
    restaurantAddress: {
      type: String,
      ...
      maxLength: [
        100,
        "La direccion del restaurante no puede exceder 100 caracteres.",
      ],
    },
    restaurantSchedule: {
      type: String,
      ...
      maxLength: [
        100,
        "El horario del restaurante no puede exceder 100 caracteres.",
      ],
    },
    restaurantCategory: {
      type: String,
      ...
      maxLength: [
        100,
        "La categoria del restaurante no puede exceder 100 caracteres.",
      ],
    },
    averagePrice: {
      type: Number,
      ...
      min: [
        0,
        "El precio promedio del restaurante debe ser mayor o igual a 0.",
      ],
    },
    contact: {
      phone: {
